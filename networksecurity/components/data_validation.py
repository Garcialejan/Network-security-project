...
# Prueba de Kolmogorov-Smirnov. Se usa para comparar dos muestras independientes 
# y determinar si provienen de la misma distribución de probabilidad subyacente.
# Es una prueba no paramétrica, lo que significa que no requiere supuestos sobre
# la forma de la distribución. Si el valor p es pequeño (por ejemplo, < 0.05), 
# se puede afirmar que ambas muestras provienen de la misma distribución.
...
class DataValidation:
    ...
    def detect_dataset_drift(self,base_df,current_df,threshold=0.05)->bool:
        '''
        We stablish a 95% of confidence interval to check the data drift
        for each column of the dfs.
        '''
        try:
            status=True
            report={}
